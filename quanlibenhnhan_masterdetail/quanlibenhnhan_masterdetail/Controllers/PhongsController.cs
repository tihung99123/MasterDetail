...
namespace quanlibenhnhan_masterdetail.Controllers
{
    public class PhongsController : Controller
    {
        ...
        public PhongsController(quanlibenhnhan_masterdetailContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,SoPhong,TienPhong")] Phong phong)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SoPhong,TienPhong")] Phong phong)
        {
            if (id != phong.Id)
            {
                return NotFound();
